...
Este repositório contém as atividades e os códigos que desenvolvi durante minha jornada de aprendizado na linguagem de programação Python.

## Conteúdo

Aqui você encontrará:

* Scripts e programas simples para praticar conceitos básicos.
* Exercícios e desafios de plataformas de aprendizado.
